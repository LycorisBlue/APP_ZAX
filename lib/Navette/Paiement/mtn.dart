...
class MTNPaiement extends StatefulWidget {
  ...
  @override
  State<MTNPaiement> createState() => _MTNPaiementState();
}

class _MTNPaiementState extends State<MTNPaiement> {
          ...
          GestureDetector(
            onTap: () {
              ...
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => CodeMTN(widget.fetchedItems, widget.selectedType,
                                  widget.selectedCity,
                                  widget.arrivalLabel,
...
class CodeMTN extends StatelessWidget {
  final Item fetchedItems;
  final String selectedType;
  final String selectedCity;
  final String arrivalLabel;
