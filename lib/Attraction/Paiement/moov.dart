...
class MoovPaiement extends StatefulWidget {
  ...
  @override
  State<MoovPaiement> createState() => _MoovPaiementState();
}

class _MoovPaiementState extends State<MoovPaiement> {
  String? token;
...
class CodeMOOV extends StatelessWidget {
  final Item fetchedItems;
  final String selectedType;
  final String selectedCity;
  final String arrivalLabel;
