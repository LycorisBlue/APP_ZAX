...
import 'package:hatooh/Attraction/Paiement/reservation_confirmee.dart';
...
class _OrangePaiementState extends State<OrangePaiement> {
  ...
  body: jsonEncode({
    'montant' : widget.attraction.tarif,
    'currency' : 'XOF',
  }));
          ...
          child: Column(
            children: [
              Container(
                ...
                child: Text(widget.attraction.nom,
                    style: GoogleFonts.roboto(
                      fontWeight: FontWeight.w500,
                      fontStyle: FontStyle.normal,
                      fontSize: 28,
              ...
              Container(
                alignment: Alignment.center,
                child: Text(widget.attraction.lieu,
          ...
          GestureDetector(
            onTap: () {
              ...
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => CodeORANGE(widget.attraction)));
            },
            child: Container(
                alignment: Alignment.center,
                height: 48,
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => ReservationConfirmee(attraction)));
            },
            child: Container(
                alignment: Alignment.center,
                height: 48,
